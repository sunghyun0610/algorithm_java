...
public class BookTest {
    ...
    public static void main(String[] args) {
        ...
        bookManager.add(new Magazine("14324", "자바의 정석", "문성현", "sunghyun.kr", 10000, "1월 알고리즘", 2021, 1,40));
        bookManager.add(new Magazine("143224", "자바의 정석2", "문성현", "sunghyun.kr", 10000, "1월 알고리즘", 2021, 1,40));
